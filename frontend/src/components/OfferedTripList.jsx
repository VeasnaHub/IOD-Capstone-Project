...
//         <p className="body-item">You have not offered any trip yet! Go Green with WAKA, click to offer a trip now! </p>
...
//                 <td className="departure-time">{offeredTrip.departureTime.slice(0, 5)}</td>
