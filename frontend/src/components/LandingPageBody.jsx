    ...
    return (
        <div className="LandingPageBody body-container">
            <div className="body-item">
                ...
                <p style={{lineHeight: "2"}}>Embrace sustainable travel with our 'Go Green' initiative, connecting users seamlessly for eco-conscious carpooling. With a sleek interface, and acommitment to environmental responsibility, we make every ride a step towards a cleaner, healthier planet.</p>
